                              ...
                              <section className="box">
                                ...
                                <footer>
                                  <ul className="actions">
                                    <li>
                                      <Link to="/game3" className="button alt">
                                        Read & Play
                                      </Link>
                                    </li>
                                  </ul>
                            ...
                            <div className="col-4 col-6-medium col-12-small">
                              <section className="box">
                                ...
                                <footer>
                                  <ul className="actions">
                                    <li>
                                      <Link to="/game2" className="button alt">
                                        Read & Play
                                      </Link>
                                    </li>
                                  </ul>
                            ...
                            <div className="col-4 col-6-medium col-12-small">
                              <section className="box">
                                ...
                                <footer>
                                  <ul className="actions">
                                    <li>
                                      <Link to="/game" className="button alt">
                                        Read & Play
                                      </Link>
                                    </li>
                                  </ul>
                            ...
                            <div className="col-4 col-6-medium col-12-small">
                              <section className="box">
                                ...
                                <footer>
                                  <ul className="actions">
                                    <li>
                                      <Link to="/game4" className="button alt">
                                        Read & Play
                                      </Link>
                                    </li>
                                  </ul>
                            ...
                            <div className="col-4 col-6-medium col-12-small">
                              <section className="box">
                                ...
                                <footer>
                                  <ul className="actions">
                                    <li>
                                      <Link to="/game5" className="button alt">
                                        Read & Play
                                      </Link>
                                    </li>
                                  </ul>
                            ...
                            <div className="col-4 col-6-medium col-12-small">
                              <section className="box">
                                ...
                                <footer>
                                  <ul className="actions">
                                    <li>
                                      <Link to="/game1" className="button alt">
                                        Read & Play
                                      </Link>
                                    </li>
                                  </ul>
